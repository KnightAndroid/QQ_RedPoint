...
//             * 布局方式请参考xml文件
//             */
//            BetterRedPointViewControl stickyViewHelper = new BetterRedPointViewControl(mContext, viewHolder.tv_dragView, R.layout.includeview, new BetterRedPointViewControl.DragStatusListener() {
//                @Override
//                public void inScope() {
